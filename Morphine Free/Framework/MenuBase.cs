...
namespace Morphine.Framework
{
    public class MenuBase
    {
        ...
        {
            return Menu.Buttons.Where(button => button.Page == page).ToList();
        }
        ...
        public static void DrawPageButtons()
        {
            ...
            gameObject.transform.localPosition = new Vector3(0.58f, 0f, 0.24f - num4);
            gameObject.AddComponent<ButtonCollider>().btn = new ButtonInfo("Previous Page", Category.Base, false, false, null, null);
            ...
            component.localPosition = new Vector3(0.064f, 0f, 0.100f - num4 / 2.55f);
            ...
            gameObject3.transform.localScale = new Vector3(0.09f, 0.82f, 0.08f);
            gameObject3.transform.localPosition = new Vector3(0.58f, 0f, 0.28f - num4);
            gameObject3.AddComponent<ButtonCollider>().btn = new ButtonInfo("Next Page", Category.Base, false, false, null, null);
        ...
        {
            int totalPages = (Menu.Buttons.Count + pageButtons - 1) / pageButtons;
        ...
        public static void CreateButton(float offset, ButtonInfo button)
        {
            ...
            buttonObj.GetComponent<Renderer>().material.shader = Shader.Find("GorillaTag/UberShader");
            buttonObj.transform.localScale = new Vector3(0.09f, 0.82f, 0.08f);
            buttonObj.transform.localPosition = new Vector3(0.58f, 0f, 0.27f - offset);
            ...
            component.localPosition = Vector3.zero;
            component.sizeDelta = new Vector2(0.2f, 0.03f);
            component.localPosition = new Vector3(0.064f, 0f, 0.106f - offset / 2.55f);
            component.rotation = Quaternion.Euler(new Vector3(180f, 90f, 90f));
        }
        ...
        public static void DrawMenu()
        {
            ...
            gameObject.transform.parent = MenuObj.transform;
            gameObject.transform.rotation = Quaternion.identity;
            gameObject.transform.localScale = new Vector3(0.1f, .97f, 1f);
            gameObject.GetComponent<Renderer>().material.shader = Shader.Find("GorillaTag/UberShader");
