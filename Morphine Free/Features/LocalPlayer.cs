...
namespace Morphine.Features
{
    public class LocalPlayer
    {
        ...
        public static Vector3 scale = new Vector3(0.0100f, 0.20f, 0.3200f);
        ...
        public static void CarMonke()
        {
            ...
            {
                GorillaLocomotion.Player.Instance.bodyCollider.attachedRigidbody.velocity += GorillaLocomotion.Player.Instance.bodyCollider.transform.forward * Time.deltaTime * 15f;
            }
